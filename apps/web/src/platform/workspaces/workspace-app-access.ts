export {
  canAccessCoreWorkspaceApp as canAccessWorkspaceApp,
  getCoreEnabledWorkspaceAppIds as getEnabledWorkspaceAppIds,
  isCoreWorkspaceAppEnabled as isWorkspaceAppEnabled,
