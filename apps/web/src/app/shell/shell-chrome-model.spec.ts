...
describe('shell chrome model', () => {
  ...
  it('uses generated route chrome for home and search apps', () => {
  ...
  it('keeps normal app routes scrollable and eligible for mobile app menu', () => {
  ...
  it('rejects an unregistered app route', () => {
