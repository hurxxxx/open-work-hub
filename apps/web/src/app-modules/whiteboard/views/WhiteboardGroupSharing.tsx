...
type Grant = ApiSchema<'WhiteboardGroupShareResponse'>;
type Role = Grant['access_level'];
function WhiteboardGroupSharingContent({
  token,
  resourceId,
  canManage,
  ...
  const endpoint = `/api/v1/whiteboard/items/${encodeURIComponent(resourceId)}/sharing/groups`;
  useEffect(() => {
...
export function WhiteboardGroupSharing(
  props: Parameters<typeof WhiteboardGroupSharingContent>[0],
) {
  return (
    <WhiteboardGroupSharingContent
