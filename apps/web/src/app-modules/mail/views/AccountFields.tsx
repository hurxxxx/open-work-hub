...
export function AccountFields({
  ...
  const set = (change: MailAccountFormChange) => {
    onChange(applyAccountFormChange(form, change, { copySharedCredentials }));
  };
    ...
    <div className="grid gap-3 md:grid-cols-2">
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'email_address', value: event.target.value })
          }
        />
      </label>
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'display_name', value: event.target.value })
          }
        />
      </label>
      <label className="grid gap-1">
        ...
        <select
          ...
          onChange={(event) =>
            set({
              field: 'protocol',
              value: event.target.value as 'imap' | 'pop3',
            })
          }
        >
      ...
      <label className="grid gap-1">
        ...
        <input
          className={fieldClassName}
          value={form.incoming_username}
          onChange={(event) =>
            set({ field: 'incoming_username', value: event.target.value })
          }
        />
      </label>
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'incoming_host', value: event.target.value })
          }
        />
      </label>
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'incoming_port', value: Number(event.target.value) })
          }
        />
      </label>
      <label className="grid gap-1">
        <span className={labelClassName}>
          {t('mail.account.incomingSecurity')}
        </span>
        <select
          className="app-field-input"
          value={form.incoming_security}
          onChange={(event) =>
            set({
              field: 'incoming_security',
              value: event.target.value as 'ssl' | 'starttls' | 'none',
            })
          }
        >
      ...
      <label className="grid gap-1">
        <span className={labelClassName}>
          {t('mail.account.incomingPassword')}
        </span>
        <input
          className={fieldClassName}
          placeholder={passwordPlaceholder}
          type="password"
          value={form.incoming_password}
          onChange={(event) =>
            set({ field: 'incoming_password', value: event.target.value })
          }
        />
      </label>
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'smtp_username', value: event.target.value })
          }
        />
      </label>
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'smtp_host', value: event.target.value })
          }
        />
      </label>
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'smtp_port', value: Number(event.target.value) })
          }
        />
      </label>
      <label className="grid gap-1">
      ...
      <label className="grid gap-1">
        ...
        <input
          ...
          onChange={(event) =>
            set({ field: 'smtp_password', value: event.target.value })
          }
        />
      </label>
    </div>
