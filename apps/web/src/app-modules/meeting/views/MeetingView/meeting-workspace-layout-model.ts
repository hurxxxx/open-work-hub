...
export function formatMeetingWorkspaceRange(
  start: string,
  end: string,
  timeZone: string,
  locale: string,
...
export type MeetingWorkspaceAction =
  ...
  | {
      ...
      notesDoc: DocsHubItem;
      notesPage: DocsPageItem;
    }
...
export const MEETING_WORKSPACE_INITIAL_STATE: MeetingWorkspaceState = {
  meeting: null,
  notesDoc: null,
  notesPage: null,
  loading: true,
...
export function meetingWorkspaceReducer(
  state: MeetingWorkspaceState,
  action: MeetingWorkspaceAction,
