import type { AspectId, LayoutId } from './layout-options';

import { IMAGE_WIZARD_WIREFRAME_COLORS } from './image-wizard-colors';
  ...
  return (
    <svg viewBox="0 0 80 50" width="80" height="50" aria-hidden>
      <rect
        ...
        height="49"
        fill="none"
        stroke={IMAGE_WIZARD_WIREFRAME_COLORS.frame}
        strokeWidth="1"
        rx="3"
      />
      {children}
            ...
            return (
              <Frame>
                ...
                <rect
                  ...
                  width="22"
                  height="2"
                  fill={IMAGE_WIZARD_WIREFRAME_COLORS.fillHeavy}
                />
                <rect
                  x="6"
                  y="20"
            ...
            return (
              <Frame>
                ...
                <rect
                  ...
                  width="34"
                  height="11"
                  fill={IMAGE_WIZARD_WIREFRAME_COLORS.fillBlock}
                  rx="1.5"
                />
                <rect
                  x="42"
            ...
            return (
              <Frame>
                <line
                  ...
                  x2="72"
                  y2="25"
                  stroke={IMAGE_WIZARD_WIREFRAME_COLORS.fillHeavy}
                  strokeWidth="1.5"
                />
