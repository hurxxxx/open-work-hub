...
from ai_do_api.domains.docs.app_catalog import DOCS_WORKSPACE_APP  # noqa: E402
from ai_do_api.domains.search.entity_adapter_registry import (  # noqa: E402
    SearchEntityAdapter,
    register_search_entity_adapter,
    reset_search_entity_adapters,
)
from ai_do_api.domains.search.entity_registry import reset_search_entity_descriptors  # noqa: E402
...
from ai_do_api.domains.search.projection_registry import (  # noqa: E402
...
def test_search_worker_routes_files_only_to_the_active_partitioned_index(
    ...
    tasks_module = _reload_worker_module("ai_do_worker.tasks.search_index")
