...
from open_alm_api.core.telemetry import start_as_current_span
...
from open_alm_api.domains.rag.metrics import (
    record_sync_job_lag,
...
from open_alm_api.domains.rag.outbox import enqueue_rag_sync_job
from open_alm_api.domains.rag.job_publication import (
    RagJobPublication,
    resolve_publication_target,
)
from open_alm_api.domains.rag.job_state import merge_recompute_cursor
...
from open_alm_api.domains.rag.providers.base import RagProviderBundle
...
from open_alm_api.domains.rag.telemetry import rag_span_attributes
...
def _execute_sync_job(
    ...
    *,
    ...
    with start_as_current_span(
        tracer_name="open_alm_worker.rag",
        span_name=span_name,
