...
from open_alm_api.core.llm import (  # noqa: E402
    LlmRuntimeError,
    LlmTaskContext,
)
...
from open_alm_api.domains.pms.models import TaskComment  # noqa: E402
...
def transcribe_recording(self, recording_id: str) -> str:
    from open_alm_api.domains.meeting.rag_sync import enqueue_meeting_rag_sync_by_id
...
def generate_meeting_doc(self, recording_id: str) -> str:
    from open_alm_api.domains.docs.minutes import create_meeting_minutes_doc
    from open_alm_api.domains.meeting.rag_sync import enqueue_meeting_rag_sync_by_id
