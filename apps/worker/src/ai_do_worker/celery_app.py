...
from ai_do_api.core.llm import get_llm_policy_seed_data  # noqa: E402
from ai_do_api.core.telemetry import bootstrap_telemetry  # noqa: E402


settings = get_settings()
# Keep telemetry bootstrapped before task modules import RAG metric wrappers.
bootstrap_telemetry(
    service_name="ai-do-worker",
...
celery_app.autodiscover_tasks(["ai_do_worker.tasks"])
...
celery_app.conf.task_routes = {
    ...
    "recording.transcribe": {"queue": "meeting_transcribe"},
    "recording.create_raw_transcript_doc": {"queue": "meeting_transcribe"},
    "recording.analyze_transcript": {"queue": "meeting_transcribe"},
    "recording.verify_transcript_summary": {"queue": "meeting_transcribe"},
    "recording.create_minutes_doc": {"queue": "meeting_transcribe"},
