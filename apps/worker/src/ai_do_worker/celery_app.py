...
from ai_do_api.core.logging_security import (  # noqa: E402
    install_sensitive_http_logging_guard,
)
from ai_do_api.platform_extensions import initialize_platform_extensions  # noqa: E402
...
if find_spec("ai_do_worker.tasks.apps.patent_prior_art.task") is not None:
