...
from ai_do_api.domains.images.models import ImageGeneration  # noqa: E402
from ai_do_api.domains.images.agent_runtime import (  # noqa: E402
    ImageGenerationRuntimeResult,
    ImageRuntimeConfigurationError,
    select_image_agent_runtime_adapter,
)
from ai_do_api.domains.images.execution_profile import (  # noqa: E402
    image_execution_requested_options,
)
from ai_do_api.domains.images.model_settings_service import (  # noqa: E402
    ImageModelSettingsError,
    ResolvedImageExecution,
    resolve_profiled_image_execution,
)
from ai_do_api.domains.images.prompt import sanitize_image_plan_text  # noqa: E402
from ai_do_api.domains.images.template_catalog import (  # noqa: E402
    get_builtin_template,
    get_user_template_source_id,
)
from ai_do_api.domains.auth.models import User, Workspace  # noqa: E402
from ai_do_api.domains.pms.models import Notification  # noqa: E402
...
def _notify_generation_finished(
    ...
    *,
    ...
    notification_id = str(uuid5(NAMESPACE_URL, f"ai-do:image-generation:{row.id}:{outcome}"))
