...
class Settings(BaseSettings):
    ...
    rag_enabled: bool = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_RAG_ENABLED",
        ),
    )
    rag_query_timeout_ms: int = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_RAG_QUERY_TIMEOUT_MS",
        ),
    )
    rag_grounded_answer_timeout_ms: int = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_RAG_GROUNDED_ANSWER_TIMEOUT_MS",
        ),
    )
    rag_qdrant_url: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_QDRANT_URL",
            "DOOWON_QDRANT_URL",
        ),
    )
    rag_qdrant_api_key: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_QDRANT_API_KEY",
    ...
    rag_qdrant_collection_prefix: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_QDRANT_COLLECTION_PREFIX",
        ),
    )
    rag_vector_index_provider: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_VECTOR_INDEX_PROVIDER",
        ),
    )
    rag_embedding_provider: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_EMBEDDING_PROVIDER",
        ),
    )
    rag_ocr_provider: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_OCR_PROVIDER",
        ),
    )
    rag_rerank_provider: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_RERANK_PROVIDER",
        ),
    )
    ...
    rag_deepinfra_base_url: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_DEEPINFRA_BASE_URL",
            "DEEPINFRA_BASE_URL",
        ),
    )
    rag_deepinfra_embedding_model: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_DEEPINFRA_EMBEDDING_MODEL",
    ...
    rag_deepinfra_reranker_model: str = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_DEEPINFRA_RERANKER_MODEL",
    ...
    rag_deepinfra_timeout: float = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "DOOWON_WORKER_AI_DO_DEEPINFRA_TIMEOUT",
            "DEEPINFRA_TIMEOUT",
        ),
    )
    rag_backfill_batch_size: int = Field(
        ...
        le=500,
        validation_alias=AliasChoices(
            "AI_DO_RAG_BACKFILL_BATCH_SIZE",
            "DOOWON_AI_DO_RAG_BACKFILL_BATCH_SIZE",
            "DOOWON_WORKER_AI_DO_RAG_BACKFILL_BATCH_SIZE",
        ),
    )
    rag_backfill_throttle_ms: int = Field(
        ...
        le=60000,
        validation_alias=AliasChoices(
            "AI_DO_RAG_BACKFILL_THROTTLE_MS",
            "DOOWON_AI_DO_RAG_BACKFILL_THROTTLE_MS",
            "DOOWON_WORKER_AI_DO_RAG_BACKFILL_THROTTLE_MS",
        ),
    )
    rag_job_max_attempts: int = Field(
        ...
        le=20,
        validation_alias=AliasChoices(
            "AI_DO_RAG_JOB_MAX_ATTEMPTS",
            "DOOWON_AI_DO_RAG_JOB_MAX_ATTEMPTS",
            "DOOWON_WORKER_AI_DO_RAG_JOB_MAX_ATTEMPTS",
        ),
    )
    rag_job_retry_backoff_seconds: int = Field(
        ...
        le=3600,
        validation_alias=AliasChoices(
            "AI_DO_RAG_JOB_RETRY_BACKOFF_SECONDS",
            "DOOWON_AI_DO_RAG_JOB_RETRY_BACKOFF_SECONDS",
            "DOOWON_WORKER_AI_DO_RAG_JOB_RETRY_BACKOFF_SECONDS",
        ),
    )
    rag_job_processing_lease_seconds: int = Field(
        ...
        le=7200,
        validation_alias=AliasChoices(
            "AI_DO_RAG_JOB_PROCESSING_LEASE_SECONDS",
            "DOOWON_AI_DO_RAG_JOB_PROCESSING_LEASE_SECONDS",
            "DOOWON_WORKER_AI_DO_RAG_JOB_PROCESSING_LEASE_SECONDS",
        ),
    )
