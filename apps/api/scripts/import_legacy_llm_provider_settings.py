"""Preview or apply the one-shot legacy external LLM settings migration."""
...
from ai_do_api.core.explicit_env_file import (  # noqa: E402
    ExplicitEnvFileError,
    load_explicit_env_file,
)
from ai_do_api.domains.ai.legacy_provider_import import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        environment = load_explicit_env_file(
            args.env_file,
            allowed_keys=LEGACY_EXTERNAL_LLM_ENV_FIELDS,
        )
    ...
    except (ExplicitEnvFileError, LegacyProviderImportError) as exc:
