...
from open_work_hub_api.core import llm, llm_execution_adapters, llm_official_providers
...
LLM_ENV_KEYS = (
    ...
    "OPEN_WORK_HUB_LLM_LOCAL_DEFAULT_MODEL",
    "OPEN_WORK_HUB_LLM_LOCAL_CANONICAL_MODEL",
    "OPEN_WORK_HUB_LLM_LOCAL_LONG_GENERATION_TIMEOUT_SECONDS",
    "OPEN_WORK_HUB_LLM_EXTERNAL_ALLOWED_PROVIDERS",
    "OPEN_WORK_HUB_LLM_EXTERNAL_LONG_GENERATION_TIMEOUT_SECONDS",
    "OPEN_WORK_HUB_LLM_OPENAI_BASE_URL",
    "OPEN_WORK_HUB_LLM_OPENAI_DEFAULT_MODEL",
    "OPEN_WORK_HUB_LLM_OPENAI_CANONICAL_MODEL",
    "OPEN_WORK_HUB_LLM_ANTHROPIC_BASE_URL",
    "OPEN_WORK_HUB_LLM_ANTHROPIC_DEFAULT_MODEL",
    "OPEN_WORK_HUB_LLM_ANTHROPIC_CANONICAL_MODEL",
    "OPEN_WORK_HUB_LLM_GEMINI_BASE_URL",
    "OPEN_WORK_HUB_LLM_GEMINI_DEFAULT_MODEL",
    "OPEN_WORK_HUB_LLM_GEMINI_CANONICAL_MODEL",
    "OPEN_WORK_HUB_LLM_REQUEST_TIMEOUT_SECONDS",
    "OPEN_WORK_HUB_LLM_HEALTHCHECK_ON_STARTUP",
    "OPEN_WORK_HUB_LLM_REQUIRED",
)
...
def test_local_pool_environment_cannot_select_model(
    ...
    monkeypatch.setenv("OPEN_WORK_HUB_LLM_LOCAL_API_KEY", "")
...
def test_external_allowed_provider_allowlist_does_not_fallback_to_all(
    ...
    monkeypatch.setenv("OPEN_WORK_HUB_LLM_EXTERNAL_ALLOWED_PROVIDERS", "typo-provider")
    get_settings.cache_clear()
...
def test_legacy_external_api_key_envs_are_not_runtime_credentials(
    ...
    for provider in ("OPENAI", "ANTHROPIC", "GEMINI"):
        monkeypatch.setenv(f"OPEN_WORK_HUB_LLM_{provider}_API_KEY", "legacy-secret")
    get_settings.cache_clear()
...
def test_legacy_external_pool_health_fails_closed_without_db_credential(
    ...
    monkeypatch.setenv("OPEN_WORK_HUB_LLM_EXTERNAL_ALLOWED_PROVIDERS", "anthropic")
    monkeypatch.setenv("OPEN_WORK_HUB_LLM_REQUEST_TIMEOUT_SECONDS", "7.5")
    get_settings.cache_clear()
...
def test_choose_pool_defaults_to_local_only_without_policy_row(
    ...
    from open_work_hub_api.core.llm import LlmTaskContext, choose_pool
...
def test_scan_pii_matches_space_separated_kr_rrn_and_phone() -> None:
    from open_work_hub_api.core.pii import scan_pii
