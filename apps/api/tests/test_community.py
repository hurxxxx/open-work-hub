...
from ai_do_api.domains.community import service
...
from ai_do_api.domains.community.router import _require_author_or_admin
from ai_do_api.domains.community.schemas import CommunityChannelCreateRequest
...
def test_comment_on_my_community_post_creates_notification_and_bot_dm(
    ...
    bot_conversation = next(
        ...
        if item["display_name"] == "AI-DO Bot"
    )
    ...
    assert message["sender_name"] == "AI-DO Bot"
