...
from ai_do_api.domains.rag.providers import RagProviderBundle
...
from ai_do_api.domains.retrieval import runtime_binding
...
from ai_do_api.domains.search.opensearch import OpenSearchError
...
def _settings(**overrides: object) -> SimpleNamespace:
    values: dict[str, object] = {
        ...
        "opensearch_index_prefix": "ai-do-test",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"physical_name": "ai-do-test_keyword_search_documents_v3_release_other"},
            {},
...
def test_partitioned_rag_query_service_is_bound_to_one_physical_collection() -> None:
    ...
    collection = "ai-do-test-rag-v1-release_20260723"
