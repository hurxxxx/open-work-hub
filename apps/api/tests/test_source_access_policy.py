...
from ai_do_api.domains.pms.models import Task, TaskUserAccess, TaskList
...
def test_source_acl_policy_blocks_inactive_resources(client: TestClient) -> None:
    ...
    with get_session_factory()() as db:
        ...
        admin = _user(db, "delivery-hub-admin@ai-do.local")
        member = _user(db, "delivery-hub-member@ai-do.local")
...
def test_pms_source_acl_uses_direct_space_membership_for_workspace_admin(
    ...
    with get_session_factory()() as db:
        ...
        workspace_admin = User(
            ...
            email="pms-source-workspace-admin@ai-do.local",
