...
from open_work_hub_api.domains.document_processing import extract_document
from open_work_hub_api.domains.document_processing import extractors as extractors_module
from open_work_hub_api.domains.document_processing import html_extractor as html_extractor_module
from open_work_hub_api.domains.document_processing.extractors import (
    DocumentExtractBundle,
    EvidenceBlock,
    UnsupportedDocumentType,
)
from open_work_hub_api.domains.document_processing.html_extractor import extract_html_stream
...
def test_pptx_extractor_stops_at_char_budget(monkeypatch: pytest.MonkeyPatch) -> None:
    from open_work_hub_api.domains.document_processing import pptx as pptx_module
