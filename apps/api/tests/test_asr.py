...
def test_asr_settings_follow_inference_gateway_env_names(monkeypatch) -> None:
    monkeypatch.setenv("AI_DO_POSTGRES_DSN", "postgresql://user:pass@localhost/db")
    monkeypatch.setenv("AI_DO_API_ASR_INFERENCE_GATEWAY_MODEL", "local-transcribe")
    monkeypatch.setenv("AI_DO_API_ASR_COHERE_MODEL", "custom-transcribe")
    monkeypatch.setenv("AI_DO_API_ASR_COHERE_BASE_URL", "https://cohere.example/v2")
