...
CLIENT_BUILD_FILE_NAME = ".ai-do-build-id"
CLIENT_BUILD_HEADER = "X-AI-DO-Web-Build"
CLIENT_RELOAD_REQUIRED_HEADER = "X-AI-DO-Reload-Required"
CLIENT_BUILD_WEBSOCKET_QUERY_PARAM = "__ai_do_build"
