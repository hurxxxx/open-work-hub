...
from ai_do_api.domains.ai_artifacts.router import router as ai_artifacts_router
from ai_do_api.domains.ai_graph.router import router as ai_graph_router
from ai_do_api.domains.admin.router import router as admin_router
from ai_do_api.domains.admin.ai_model_settings_router import (
    router as admin_ai_model_settings_router,
)
from ai_do_api.domains.admin.api_keys_router import router as admin_api_keys_router
from ai_do_api.domains.admin.document_processing_router import (
    router as admin_document_processing_router,
)
from ai_do_api.domains.admin.image_model_settings_router import (
    router as admin_image_model_settings_router,
)
from ai_do_api.domains.admin.model_runtime_status_router import (
    router as admin_model_runtime_status_router,
)
from ai_do_api.domains.announcements.router import router as announcements_router
from ai_do_api.domains.auth.dependencies import (
    require_current_user,
    require_workspace_membership,
)
from ai_do_api.domains.auth.router import router as auth_router
from ai_do_api.domains.auth.apps_router import router as apps_router
...
from ai_do_api.domains.community.router import router as community_router
from ai_do_api.domains.dataviz.router import router as dataviz_router
from ai_do_api.domains.dataviz.sys_perf_router import router as sys_perf_router
...
from ai_do_api.domains.diagrams.router import router as diagrams_router
from ai_do_api.domains.dm.router import public_router as dm_public_router
from ai_do_api.domains.dm.router import router as dm_router
from ai_do_api.domains.drafts.router import router as drafts_router
from ai_do_api.domains.files.router import public_router as files_public_router
from ai_do_api.domains.files.router import router as files_router
from ai_do_api.domains.images.router import router as images_router
from ai_do_api.domains.hr.integration_router import router as hr_integration_router
from ai_do_api.domains.industry_report.router import router as industry_report_router
from ai_do_api.domains.lawsearch.router import router as lawsearch_router
from ai_do_api.domains.learning_notes.router import router as learning_notes_router
from ai_do_api.domains.legacy_issues.router import router as legacy_issues_router
from ai_do_api.domains.mail.router import router as mail_router
from ai_do_api.domains.management_tasks.router import router as management_tasks_router
from ai_do_api.domains.news.router import router as news_router
from ai_do_api.domains.meal_invoice_ocr.router import router as meal_invoice_ocr_router
from ai_do_api.domains.media.router import public_router as media_public_router
from ai_do_api.domains.media.router import router as media_router
from ai_do_api.domains.meeting.router import public_router as meeting_public_router
from ai_do_api.domains.meeting.router import router as meeting_router
from ai_do_api.domains.notifications.router import router as notifications_router
from ai_do_api.domains.ocr.router import router as ocr_router
from ai_do_api.domains.patent.router import router as patent_router
from ai_do_api.domains.patent_automation.router import router as patent_automation_router
from ai_do_api.domains.patent_prior_art.router import router as patent_prior_art_router
from ai_do_api.domains.personal_widgets.router import router as personal_widgets_router
...
from ai_do_api.domains.pms.router import public_router as pms_public_router
from ai_do_api.domains.pms.router import router as pms_router
from ai_do_api.domains.ppt_generator.router import router as ppt_generator_router
from ai_do_api.domains.qna.router import router as qna_router
from ai_do_api.domains.rag.router import router as rag_router
from ai_do_api.domains.release_notes.router import router as release_notes_router
from ai_do_api.domains.recording.router import router as recording_router
from ai_do_api.domains.realtime.router import ws_router as realtime_ws_router
from ai_do_api.domains.retrieval.router import router as retrieval_router
from ai_do_api.domains.search.router import router as search_router
from ai_do_api.domains.document_translate.router import router as document_translate_router
from ai_do_api.domains.fmea_compare.router import router as fmea_compare_router
from ai_do_api.domains.imds_minerals.router import router as imds_minerals_router
from ai_do_api.domains.spec_compare.router import router as spec_compare_router
from ai_do_api.domains.usage.router import router as usage_router
from ai_do_api.domains.video_chat.router import router as video_chat_router
from ai_do_api.domains.web_search.router import (
    research_trends_router,
    router as web_search_router,
    standards_monitor_router,
)
from ai_do_api.domains.writing_assistant.router import router as writing_assistant_router
