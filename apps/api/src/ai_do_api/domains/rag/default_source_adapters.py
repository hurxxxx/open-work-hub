...
from ai_do_api.domains.rag.contracts import RagSyncLane, RagSyncOperation
from ai_do_api.domains.rag.source_registry import (
...
def ensure_rag_source_adapters_registered() -> None:
    ...
    from ai_do_api.domains.rag.meeting_projection import load_meeting_projection
    ...
    from ai_do_api.domains.qna.projection import (
        company_qna_document_ids,
        load_qna_document_projection,
        workspace_qna_document_ids,
    )
    from ai_do_api.domains.qna.service import (
...
def _native_doc_source_label(source_kind: str) -> str:
    from ai_do_api.domains.rag.source_registry import OFFICIAL_NATIVE_DOC_SOURCE_KIND_LABELS
