...
from ai_do_api.domains.dataviz import service
from ai_do_api.domains.dataviz.app_catalog import DATA_VIZ_WORKSPACE_APP
from ai_do_api.domains.dataviz.compressor_perf import (
    CATEGORY_ELECTRIC,
    CATEGORY_VARIABLE,
    average_by_group,
    parse_perf_source,
...
from ai_do_api.domains.dataviz import comp_reliability as rel
from ai_do_api.domains.dataviz.core_measurement import ModelGroup, load_groups
