...
from ai_do_api.domains.patent_automation import approval_html
from ai_do_api.domains.patent_automation import field_defs as fd
from ai_do_api.domains.patent_automation import history, invoice_pipeline, service, summary_xlsx
from ai_do_api.domains.patent_automation.app_catalog import PATENT_AUTOMATION_WORKSPACE_APP
from ai_do_api.domains.patent_automation.models import PatentCostLine, PatentCostRun
from ai_do_api.domains.patent_automation.schemas import (
    ApprovalHtmlOut,
    CostLineOut,
    CostRunOut,
    HistoryEntryOut,
