...
from ai_do_api.domains.web_search import service
from ai_do_api.domains.web_search.app_catalog import (
    RESEARCH_TRENDS_WORKSPACE_APP,
    STANDARDS_MONITOR_WORKSPACE_APP,
    WEB_SEARCH_WORKSPACE_APP,
)
from ai_do_api.domains.web_search.schemas import WebSearchAskRequest
