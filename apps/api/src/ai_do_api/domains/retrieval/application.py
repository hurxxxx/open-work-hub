...
from ai_do_api.domains.auth.access import resolve_workspace_runtime_enabled_app_ids
...
from ai_do_api.domains.retrieval.grounding import ground_ranked_hits
from ai_do_api.domains.retrieval.metrics import (
...
def search_legacy_issue_evidence_response(
    ...
    *,
    ...
    from ai_do_api.domains.legacy_issues.ai_search import search_legacy_issue_evidence
...
def _query_qna_rag(
    ...
    *,
    ...
    from ai_do_api.domains.qna.constants import QNA_DOC_SOURCE_KIND
