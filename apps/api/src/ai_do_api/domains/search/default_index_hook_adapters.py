...
def ensure_search_index_hooks_registered() -> None:
    from ai_do_api.domains.docs import search_hooks as docs_hooks
    from ai_do_api.domains.files import search_hooks as files_hooks
    from ai_do_api.domains.meeting import search_hooks as meeting_hooks
    from ai_do_api.domains.pms import search_hooks as pms_hooks
