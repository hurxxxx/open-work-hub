...
from ai_do_api.domains.legacy_issues.analysis_v2.tools import (
    AnalysisToolset,
...
class AiDoChatModel:
    ...
    AI-DO's provider-neutral completion currently exposes text only. bind_tools
