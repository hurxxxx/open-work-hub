...
class LegacyIssueDocumentStatusResponse(BaseModel):
    attachment_index_enabled: bool
    always_use_vision: bool
    vision_max_pages: int
    maximum_chunks: int
    semantic_search_enabled: bool
    write_embeddings_enabled: bool
    embedding_dimensions: int
    vector_store: Literal["postgresql_pgvector"] = "postgresql_pgvector"
