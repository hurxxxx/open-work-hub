...
from ai_do_api.domains.auth.access import get_current_workspace, resolve_workspace_role
...
from ai_do_api.domains.source_access.access_scope import AccessScopePolicy
...
class SourceAclPolicy:
    ...
    def restrict_visible_native_docs(self, base):
        from ai_do_api.domains.docs import source_access
