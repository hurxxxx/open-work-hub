...
from ai_do_api.domains.media.service import MEDIA_ID_PATTERN
...
def _can_access_task_resource(db: Session, user: User, task_id: str | None) -> bool:
    ...
    from ai_do_api.domains.pms.models import Task, TaskList
...
def _can_access_ppt_template_preview(
    ...
    from ai_do_api.domains.ppt_generator.models import PptTemplatePreviewImage
...
def _can_access_community_post_resource(
    ...
    from ai_do_api.domains.community.models import CommunityPost
...
def _can_access_community_comment_resource(
    ...
    from ai_do_api.domains.community.models import CommunityComment
