...
def _maybe_suggest_name(
    ...
    """
    from ai_do_api.domains.meal_invoice_ocr.catalog import best_match as catalog_match
...
def _rescan_band_into_payload(
    ...
    *,
    ...
    if aligned_by_index:
        ...
        from ai_do_api.domains.meal_invoice_ocr.vocab import best_match
    ...
    from ai_do_api.domains.meal_invoice_ocr.vocab import _score as _name_score
...
def annotate_vocab(doc: MealInvoiceDocument, vocab: list[str] | None) -> MealInvoiceDocument:
    ...
    if not vocab:
        return doc
    from ai_do_api.domains.meal_invoice_ocr.vocab import best_match, confusable_alt
...
def annotate_catalog(
    ...
    if not catalog:
        return doc
    from ai_do_api.domains.meal_invoice_ocr.catalog import (
...
def _apply_vendor_aliases(
    ...
    *,
    ...
    """
    from ai_do_api.domains.meal_invoice_ocr.vocab import _score as _name_score, initials
...
def extract_documents(
    ...
    *,
    ...
    from ai_do_api.domains.meal_invoice_ocr.catalog import build_item_hint
