...
from ai_do_api.domains.search.backend_contracts import KeywordSearchClient, KeywordSearchQuery
...
from ai_do_api.domains.search.service import _search_client
