...
from ai_do_api.ai_do_desktop_update_manifest import (
    ...
    ai_do_desktop_update_manifest_projection,
)
...
class DesktopUpdateServingPolicy:
    ...
    def from_manifest(
        ...
        resolved_manifest = manifest or ai_do_desktop_update_manifest_projection()
        return cls(
...
def ai_do_desktop_update_serving_policy() -> DesktopUpdateServingPolicy:
