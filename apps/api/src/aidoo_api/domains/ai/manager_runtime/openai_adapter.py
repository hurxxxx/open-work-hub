...
from aidoo_api.domains.ai.events import AgentEventEnvelope, make_envelope
from aidoo_api.domains.ai.internal_agent_contracts import LocalAgentTask
...
def build_openai_ai_manager_run_config(
    ...
    return RunConfig(
        ...
        workflow_name="aidoo_ai_manager",
        trace_metadata={
