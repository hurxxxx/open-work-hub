...
from aidoo_api.domains.pms.models import Issue, IssueComment, TaskList
from aidoo_api.domains.search.service import refresh_workspace_keyword_index


WORKSPACE_KEY = "delivery-hub"
ADMIN_EMAIL = "delivery-hub-admin@aidoo.local"
MEMBER_EMAIL = "delivery-hub-member@aidoo.local"
SAMPLE_PREFIX = "[검색검증]"
    ...
    for index in range(30):
        ...
        db.add(
            PlannerEvent(
                ...
                location="Aidoo HQ 5F" if index % 2 == 0 else "Remote",
