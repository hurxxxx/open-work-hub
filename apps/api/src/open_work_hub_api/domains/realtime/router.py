...
from open_work_hub_api.domains.docs import realtime_protocol as docs_realtime_protocol
from open_work_hub_api.domains.notifications import realtime_event_types as notification_realtime_event_types
