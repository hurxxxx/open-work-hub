...
def ensure_search_index_hooks_registered() -> None:
    from open_work_hub_api.domains.docs import search_hooks as docs_hooks
    from open_work_hub_api.domains.files import search_hooks as files_hooks
    from open_work_hub_api.domains.meeting import search_hooks as meeting_hooks
    from open_work_hub_api.domains.pms import search_hooks as pms_hooks
