...
from open_work_hub_api.domains.ai.boundary_safety import ExternalPayloadSafetyDecision
...
def resolve_ai_security_external_transfer_exception(
    ...
    exceptions = db.scalars(_matching_exceptions_statement(resolved_context)).all()
    matches = [
        match
