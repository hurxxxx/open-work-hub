...
from open_work_hub_api.domains.auth.security import hash_password, new_id
...
from open_work_hub_api.domains.dm.models import DmConversation, DmMessage
...
OPEN_WORK_HUB_BOT_USER_ID = "open-work-hub-notification-bot"
OPEN_WORK_HUB_BOT_LOGIN_ID = "open-work-hub-bot"
OPEN_WORK_HUB_BOT_EMAIL = "open-work-hub-bot@open-work-hub.local"
OPEN_WORK_HUB_BOT_NAME = "Open Work Hub Bot"
...
def ensure_notification_bot_user(db: Session) -> User:
    bot = db.get(User, OPEN_WORK_HUB_BOT_USER_ID)
    if bot is not None:
        _normalize_bot_user(bot)
        return bot

    bot = User(
        id=OPEN_WORK_HUB_BOT_USER_ID,
        login_id=OPEN_WORK_HUB_BOT_LOGIN_ID,
        email=OPEN_WORK_HUB_BOT_EMAIL,
        full_name=OPEN_WORK_HUB_BOT_NAME,
        display_name=OPEN_WORK_HUB_BOT_NAME,
...
def _normalize_bot_user(bot: User) -> None:
    bot.login_id = OPEN_WORK_HUB_BOT_LOGIN_ID
    bot.email = OPEN_WORK_HUB_BOT_EMAIL
    bot.full_name = OPEN_WORK_HUB_BOT_NAME
    bot.display_name = OPEN_WORK_HUB_BOT_NAME
    bot.status = "system"
