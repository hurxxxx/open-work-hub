...
from open_work_hub_api.domains.document_translate import service
from open_work_hub_api.domains.document_translate.app_catalog import DOCUMENT_TRANSLATE_WORKSPACE_APP
from open_work_hub_api.domains.document_translate.schemas import (
    DocMode,
    DocProcessResult,
