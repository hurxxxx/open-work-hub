...
from open_work_hub_api.domains.pms.models import Task, TaskDocLink, TaskList
...
def create_page(
    ...
    *,
    ...
    from open_work_hub_api.domains.docs.page_mutations import create_native_page_from_markdown
