...
from open_work_hub_api.domains.ai_artifacts.contracts import AiArtifactCreate
...
from open_work_hub_api.domains.ai_graph.contracts import AiGraphDispatchCreate, AiGraphRunRequest
