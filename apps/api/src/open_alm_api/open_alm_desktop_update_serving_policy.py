...
from open_alm_api.open_alm_desktop_update_manifest import (
    ...
    open_alm_desktop_update_manifest_projection,
)
...
class DesktopUpdateServingPolicy:
    ...
    def from_manifest(
        ...
        resolved_manifest = manifest or open_alm_desktop_update_manifest_projection()
        return cls(
...
def open_alm_desktop_update_serving_policy() -> DesktopUpdateServingPolicy:
