...
from open_alm_api.domains.legacy_issues.analysis_graph.dispatch import (
...
from open_alm_api.domains.legacy_issues.ai_evidence_payload import (
...
class LegacyIssueConversationScopeAdapter:
    ...
    def system_prompt(
        ...
        *,
        ...
        return (
            "너는 Open ALM 과거차 문제점 분석 AI다. 인사, 감사, 기능 질문, "
