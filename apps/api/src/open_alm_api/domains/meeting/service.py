...
from open_alm_api.domains.meeting.attachment_grants import (
...
from open_alm_api.domains.meeting import notes_lifecycle
from open_alm_api.domains.meeting.availability_projection import build_meeting_availability
...
from open_alm_api.domains.meeting.detail_projection import (
...
from open_alm_api.domains.meeting.permissions import (
    ensure_doc_attachable,
    ensure_link_remover,
    ensure_meeting_participant,
)
from open_alm_api.domains.meeting.rag_sync import enqueue_meeting_rag_sync
...
from open_alm_api.domains.pms.access import ensure_task_attachable
...
from open_alm_api.domains.source_access import can_read_meeting
from open_alm_api.domains.whiteboard.models import Whiteboard, WhiteboardTarget
...
def _load_meeting(db: Session, workspace: Workspace, meeting_id: str) -> Meeting:
    from open_alm_api.domains.meeting.models import MeetingRecordingStaging
...
def update_meeting(
    ...
    *,
    ...
    from open_alm_api.domains.meeting.permissions import ensure_meeting_organizer
...
def delete_meeting(db: Session, *, workspace: Workspace, user: User, meeting_id: str) -> None:
    from open_alm_api.domains.meeting.permissions import ensure_meeting_organizer
    from open_alm_api.domains.meeting.recordings import cleanup_meeting_recordings
