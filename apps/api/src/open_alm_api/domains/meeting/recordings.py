...
from open_alm_api.domains.meeting.permissions import ensure_meeting_participant
from open_alm_api.domains.pms.access import _ensure_task_readable as ensure_task_readable
from open_alm_api.domains.recording import blob_store as recording_blob_store
...
def cleanup_stale_staging_once(db: Session) -> dict[str, int]:
    from open_alm_api.domains.recording.models import RecordingStaging
