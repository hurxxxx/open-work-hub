...
from open_alm_api.domains.admin.document_processing_projection import (
...
from open_alm_api.domains.auth.dependencies import AuthContext, require_permission
