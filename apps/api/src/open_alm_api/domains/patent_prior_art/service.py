...
from open_alm_api.domains.document_processing import (
...
from open_alm_api.domains.patent_prior_art.catalog import (
...
from open_alm_api.domains.patent_prior_art.result_projection import (
    project_job,
    project_result,
)
...
def preview_query(
    ...
    *,
    ...
    from open_alm_api.domains.patent_prior_art.pipeline import (  # noqa: PLC0415
...
def create_job(
    ...
    *,
    ...
    from open_alm_api.domains.patent_prior_art.planning import (  # noqa: PLC0415
        build_display_query,
    ...
    *,
    ...
    if isinstance(rich_ctx, dict):
        ...
        if isinstance(criteria, dict):
            ...
            try:
                from open_alm_api.domains.ai.model_settings_service import (  # noqa: PLC0415
