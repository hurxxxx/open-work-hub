...
from open_alm_api.domains.images.prompt_context import format_image_context_block
from open_alm_api.domains.images.template_catalog import describe_template_for_prompt
