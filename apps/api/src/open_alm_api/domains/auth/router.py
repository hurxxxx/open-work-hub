...
from open_alm_api.core.settings import (
    get_settings,
...
from open_alm_api.domains.auth.app_bar_preferences import (
...
from open_alm_api.domains.auth.groupware_http import (
...
def dev_admin_login(
    ...
    candidates = db.scalars(
        ...
        .order_by((User.email == "admin@open-alm.local").desc(), User.created_at.asc())
    ).all()
    user = next(
        (
            candidate
