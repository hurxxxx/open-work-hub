...
from open_alm_api.domains.notifications import dm_delivery
from open_alm_api.domains.notifications import realtime_event_types as notification_event_types
