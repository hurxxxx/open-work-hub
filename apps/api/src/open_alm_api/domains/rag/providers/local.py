...
from open_alm_api.domains.rag.contracts import RagProviderHealth, RagVectorSearchHit
...
from open_alm_api.domains.rag.providers.rerank_text import build_rerank_document_text
...
class DoclingOcrClient:
    ...
    def extract_text(self, *, content: bytes, content_type: str | None = None) -> str:
        ...
        with tempfile.TemporaryDirectory(prefix="open-alm-dev-rag-docling-") as tmp:
