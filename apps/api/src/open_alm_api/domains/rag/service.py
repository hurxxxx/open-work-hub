...
from open_alm_api.domains.rag.projection import projection_to_chunks
...
from open_alm_api.domains.rag.vector_records import (
...
class RagService:
    def __init__(
        ...
        *,
        ...
        default_collection: str = "open-alm-dev-rag-dev",
    ) -> None:
