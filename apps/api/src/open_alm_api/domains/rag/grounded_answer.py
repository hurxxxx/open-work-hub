...
from open_alm_api.domains.rag.contracts import RagGroundedAnswer, RagGroundedCitation, RagQueryHit
from open_alm_api.domains.rag.grounded_answer_assembly import (
...
class LlmGroundedAnswerSynthesizer:
    provider_name = "corporate-llm-grounded-answer"
