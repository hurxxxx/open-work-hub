...
from open_alm_api.core.telemetry import get_tracer
from open_alm_api.core.principal import CallerPrincipal
from open_alm_api.domains.ai import approvals as ai_approvals
from open_alm_api.domains.ai.audit import log_llm_tool_call
from open_alm_api.domains.ai.tool_error_projection import tool_http_exception_message
...
from open_alm_api.domains.ai.tool_context import ToolExecutionContext, bind_tool_execution_context
from open_alm_api.domains.ai.tool_result_projection import (
...
def execute_tool(
    ...
    *,
    ...
    tracer = get_tracer("open_alm_api.ai.tools")
