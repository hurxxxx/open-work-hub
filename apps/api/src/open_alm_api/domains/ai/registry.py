...
from open_alm_api.domains.ai.schema_compile import compile_input_schemas
...
def get_ai_capability_registry() -> AiCapabilityRegistry:
    ...
    for module_name in (
        "open_alm_api.domains.ai",
        "open_alm_api.domains.docs",
        "open_alm_api.domains.files",
        "open_alm_api.domains.legacy_issues",
        "open_alm_api.domains.mail",
        "open_alm_api.domains.meal_invoice_ocr",
        "open_alm_api.domains.meeting",
        "open_alm_api.domains.planner",
        "open_alm_api.domains.pms",
        "open_alm_api.domains.ppt_generator",
        "open_alm_api.domains.spec_compare",
        "open_alm_api.domains.patent_automation",
        "open_alm_api.domains.patent_prior_art",
        "open_alm_api.domains.retrieval",
        "open_alm_api.domains.rag",
        "open_alm_api.domains.web_search",
    ):
