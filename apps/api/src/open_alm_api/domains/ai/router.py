...
from open_alm_api.domains.ai.agent import (
    AGENT_SYSTEM_PROMPT,
    resume_agent_run,
    run_agent_turn_stream,
)
from open_alm_api.domains.ai import approvals as ai_approvals
from open_alm_api.domains.ai.audit import log_llm_tool_approval_resolved
from open_alm_api.domains.ai.assistant_turns import (
    AssistantTurnBuffer,
...
from open_alm_api.domains.ai.conversation_scope import (
...
from open_alm_api.domains.ai.mcp import AiMcpClient
...
from open_alm_api.domains.ai.runtime.metrics import (
...
from open_alm_api.domains.ai.runtime.models import AgentInvocation, AgentRun, AgentTraceEvent
...
from open_alm_api.domains.ai.runtime.agent_definitions import resolve_agent_definitions
from open_alm_api.domains.ai.runtime.manager_candidate import (
    build_deterministic_manager_candidate,
    summarize_execution_graph,
)
from open_alm_api.domains.ai.runtime.graph_scheduler import (
    GraphSchedulerError,
...
from open_alm_api.domains.ai.runtime.external_trace import (
    external_planner_trace_summaries,
    external_search_trace_summaries,
)
from open_alm_api.domains.ai.runtime.graph_execution import (
    attach_graph_execution_adapter_decision,
)
from open_alm_api.domains.ai.runtime.graph_stream import (
    attach_graph_execution_adapter_error_summary,
    run_graph_execution_adapter_stream,
    should_use_graph_execution_adapter,
)
from open_alm_api.domains.ai.runtime.manager_validation import ManagerGraphValidator
from open_alm_api.domains.ai.runtime.routing import (
...
from open_alm_api.domains.ai.runtime.tool_calling import stream_tool_calling_enabled
from open_alm_api.domains.ai.tool_runtime import ToolCallExecution
from open_alm_api.domains.ai.tool_pipeline import (
    ToolChatCommand,
...
from open_alm_api.domains.ai.tool_service import (
...
from open_alm_api.domains.auth.workspace_app_gate import is_workspace_app_enabled
...
from open_alm_api.domains.conversations.schemas import (
...
from open_alm_api.domains.conversations.projections import (
    ...
    *,
    ...
    def terminal_from_http_exception(exc: HTTPException) -> list[dict[str, str]]:
        ...
        if isinstance(detail, LocalizedApiMessage):
            ...
            code = (
                exc.headers.get("X-Open ALM-Error-Code", "conversation_error")
                if exc.headers
