...
from open_alm_api.domains.ai.gateway import resolve_llm_workload_route
...
from open_alm_api.domains.web_search.schemas import (
    WebSearchAnswerResponse,
    WebSearchCitation,
    WebSearchUsage,
)
from open_alm_api.domains.web_search import WEB_SEARCH_WORKLOAD_IDS


WEB_SEARCH_TOOL_TYPE = "web_search_20250305"

SYSTEM_PROMPT = """\
You are a web search assistant for Open ALM.
...
You are a research and technology trend analyst for Open ALM.
...
4. Potential Open ALM use cases
...
You are a standards and regulatory monitoring analyst for Open ALM.
