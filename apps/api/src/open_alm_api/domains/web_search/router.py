...
from open_alm_api.domains.conversations import app_persistence
from open_alm_api.domains.conversations.app_scope_adapters import (
    RESEARCH_TRENDS_SCOPE_REF,
    STANDARDS_MONITOR_SCOPE_REF,
    WEB_SEARCH_SCOPE_REF,
)
from open_alm_api.domains.web_search import service
from open_alm_api.domains.web_search.app_catalog import (
    RESEARCH_TRENDS_WORKSPACE_APP,
    STANDARDS_MONITOR_WORKSPACE_APP,
    WEB_SEARCH_WORKSPACE_APP,
)
from open_alm_api.domains.web_search.schemas import WebSearchAskRequest
...
research_trends_router = build_web_search_router(
    prefix="/research-trends",
    app_id=RESEARCH_TRENDS_WORKSPACE_APP.app_id,
    profile_id="research-trends",
    conversation_scope_ref=RESEARCH_TRENDS_SCOPE_REF,
    tag="research-trends",
)
standards_monitor_router = build_web_search_router(
    prefix="/standards-monitor",
    app_id=STANDARDS_MONITOR_WORKSPACE_APP.app_id,
    profile_id="standards-monitor",
    conversation_scope_ref=STANDARDS_MONITOR_SCOPE_REF,
    tag="standards-monitor",
)
