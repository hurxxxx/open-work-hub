...
from open_alm_api.domains.document_processing.contracts import UnsupportedDocumentType
from open_alm_api.domains.document_processing.extractors import extract_document
from open_alm_api.domains.media.proxy_urls import build_media_proxy_url
...
from open_alm_api.domains.ppt_generator.prompts import compute_slide_count
...
def _get_celery_client() -> Celery:
    ...
    return create_fail_fast_celery_publisher(
        "open_alm_api_ppt_generator_app",
