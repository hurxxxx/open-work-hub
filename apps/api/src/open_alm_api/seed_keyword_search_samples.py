...
from open_alm_api.domains.docs.models import NativeDoc, NativeDocTarget, NativeDocPage
...
from open_alm_api.domains.pms.models import Task, TaskComment, TaskList
from open_alm_api.domains.retrieval.partitioning import assign_default_partition
from open_alm_api.domains.search.service import refresh_workspace_keyword_index


WORKSPACE_KEY = "ai-tft"
ADMIN_EMAIL = "admin@open-alm.local"
...
def _seed_events(db: Session, workspace: Workspace, owner: User) -> int:
    ...
    for index in range(30):
        ...
        event = PlannerEvent(
            ...
            location="Open ALM HQ 5F" if index % 2 == 0 else "Remote",
