...
CLIENT_BUILD_FILE_NAME = ".open-alm-build-id"
CLIENT_BUILD_HEADER = "X-Open ALM-Web-Build"
CLIENT_RELOAD_REQUIRED_HEADER = "X-Open ALM-Reload-Required"
CLIENT_BUILD_WEBSOCKET_QUERY_PARAM = "__open_alm_build"
