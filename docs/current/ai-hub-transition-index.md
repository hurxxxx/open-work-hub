...
AI-DO는 자체 워크스페이스, 권한, 문서, PMS, 검색/RAG, AI 챗봇, 여러 후속 앱과
...
현재 대표 사례는 `legacy-issues` 확장 앱이며, DWDCC 환경에서만 노출되는 운영 정책을 갖는다.
...
| 영역         | 현재 원장                          | AI-DO 역할                                                     |
| ------------ | ---------------------------------- | -------------------------------------------------------------- |
| 사용자/권한  | AI-DO tenant Auth + Workspace/RBAC | 회사 사용자·전역 관리자, workspace membership/ACL, 감사의 기준 |
| 메일         | 미완성 AI-DO Mail 코드             | 현재 미운영이며 개발 지속 여부 미정. RAG 운영 색인 대상도 아님 |
| 태스크/PMS   | AI-DO PMS                          | 보드/리스트/업무 추적과 AI 보조                                |
| 일정/Planner | AI-DO Planner/Calendar             | 일정 조회, 검색, 업무 연결                                     |
| 회의/녹음    | 미완성 AI-DO Meeting/Recording     | 현재 미운영. 향후 완성·인수 승인 전 업무 기능으로 안내하지 않음 |
| 문서/파일    | AI-DO Docs/Files                   | Docs native RAG와 Files partitioned retrieval 운영 활성 |
| 내부 앱 제작 | AI-DO                              | 현업 소형 업무 앱 템플릿, 가드레일, 배포면                     |
| AI 검색/챗봇 | AI-DO                              | 내부 원본을 근거 기반으로 검색하고 답변                        |
...
- AI-DO가 직접 소유할 기능은 검색 품질, AI 챗봇, 자동화 보조, 현업 앱 제작 경험을
