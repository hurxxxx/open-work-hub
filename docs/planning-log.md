...
- **영향 파일**: `apps/api/src/ai_do_api/core/i18n.py`, `apps/api/src/ai_do_api/domains/`, `apps/web/src/platform/i18n/`, `apps/web/src/app-modules/`, `packages/ui/src/`, `scripts/check-*-i18n-*`
...
- **영향 파일**: `apps/api/src/ai_do_api/domains/auth/`, `apps/web/src/platform/time/`, `apps/web/src/platform/auth/settings-pages.tsx`, `apps/web/src/app/shell/AppContent.tsx`, `apps/web/src/components/layout/AppBar.tsx`, `apps/web/src/app-modules/{pms,meeting}/`
...
- **PR/커밋**: 미커밋
- **영향 파일**: `apps/api/src/ai_do_api/domains/search/outbox.py`, `apps/api/src/ai_do_api/domains/rag/outbox.py`, `apps/api/tests/test_search_index_outbox.py`, `apps/api/tests/test_rag_outbox.py`, 로컬 `.env`
...
- **PR/커밋**: 미커밋
- **영향 파일**: `apps/api/src/ai_do_api/domains/search/projections.py`, `apps/api/src/ai_do_api/domains/meeting/service.py`, `apps/api/tests/test_search_index_hooks.py`
...
- **PR/커밋**: 미커밋
- **영향 파일**: `apps/api/src/ai_do_api/domains/search/`, `apps/api/src/ai_do_api/domains/pms/`
...
- **영향 파일**: `apps/api/src/ai_do_api/domains/search/`
...
- **PR/커밋**: 9db6436, 59f59d6
- **영향 파일**: `apps/api/src/ai_do_api/domains/search/`, `apps/web/src/components/views/RagSearchView.tsx`
...
- **PR/커밋**: 미커밋
- **영향 파일**: `apps/api/src/ai_do_api/domains/learning_notes/`, `apps/api/tests/test_learning_notes.py`, `apps/api/src/ai_do_api/app.py`, `apps/web/src/domains/learning-notes/`, `apps/web/src/components/views/learning-notes/`, `apps/web/src/components/views/LearningCourseView.tsx`, `apps/web/src/components/layout/SubSidebar.tsx`, `apps/web/src/domains/learning/manifest.ts`, `apps/web/src/domains/workspaces/workspace-utils.ts`, `apps/web/src/constants.ts`, `apps/web/src/app-shell.ts`, `learning/README.md`
...
- **PR/커밋**: 미커밋
- **영향 파일**: `apps/api/src/ai_do_api/seed_keyword_search_samples.py`, `apps/api/src/ai_do_api/domains/search/service.py`, `apps/web/src/components/views/RagSearchView.tsx`
...
- **영향 파일**: `apps/api/src/ai_do_api/domains/rag/`, `apps/api/src/ai_do_api/domains/{docs,meeting,pms,planner}/`, `apps/api/src/ai_do_api/core/{settings,telemetry}.py`, `apps/api/alembic/versions/{fa12bc34de56_add_rag_sync_jobs.py,c1d2e3f4a5b6_add_rag_pending_unique_indexes.py}`, `apps/worker/src/ai_do_worker/tasks/rag_sync.py`, `apps/web/src/domains/rag/`, `apps/web/src/components/views/RagSearchView.tsx`, `apps/web/src/App.tsx`
...
- **PR/커밋**: 다수 구현 커밋
- **영향 파일**: `apps/api/src/ai_do_api/domains/ai/`, `apps/api/src/ai_do_api/domains/{meeting,pms,planner,docs}/`, `apps/api/src/ai_do_api/domains/conversations/`, `apps/worker/src/ai_do_worker/tasks/meeting.py`, `apps/web/src/domains/ai/`, `apps/web/src/components/views/AIView.tsx`
...
- **PR/커밋**: fe23cff
- **영향 파일**: `apps/api/src/ai_do_api/core/llm.py`, `apps/api/src/ai_do_api/core/pii.py`, `apps/api/src/ai_do_api/domains/ai/`, `apps/api/alembic/versions/c7a2f1e8b3d4_add_llm_policies.py`, `apps/worker/src/ai_do_worker/`, `apps/web/src/domains/ai/`
