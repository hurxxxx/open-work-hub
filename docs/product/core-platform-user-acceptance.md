...
| LIVE-10 | In Community, B creates a company post. A opens it and comments. B opens notifications and marks the notification read.                                                                                                                                                                                                                              | Community has no workspace selector. B receives exactly one source-owned notification with the canonical post link; unread state clears immediately and remains clear after reload.                                                                                                                                                                                    |
