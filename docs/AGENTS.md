...
- Technical contracts belong in `docs/domains/`, app behavior in `docs/apps/`, product rules in `docs/product/`, and agent routing/checks in `docs/agents/`; use the narrowest owner and update links after moves.
