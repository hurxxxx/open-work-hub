---
name: open-alm-docs-organization
description: Organize Open ALM documentation ownership and source-of-truth links. Use when moving, creating, deleting, reorganizing, or resolving the correct owner/location of project docs. Do not use for simple reading, summarization, or an in-place edit to an already-owned document.
---

# Open ALM Docs Organization
