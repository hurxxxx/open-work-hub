...
When exploring the codebase, use terminology from the owning domain/app documents so test names and interface vocabulary match the project, and respect accepted decisions in root `adr/`.
