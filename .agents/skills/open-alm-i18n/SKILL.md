---
name: open-alm-i18n
description: Review and fix Open ALM localization contracts. Use when changing translation keys/catalogs, adding user-facing copy that must be localized, or diagnosing locale parity/dynamic-message failures. Do not use for prose-only docs or copy that is not rendered by the product.
---
