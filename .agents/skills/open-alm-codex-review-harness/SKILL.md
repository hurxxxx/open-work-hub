---
name: open-alm-codex-review-harness
description: Maintain Open ALM's local Codex CLI GitLab MR review pipeline, runner script, MR comment contract, and enforced review decision gate. Use when changing codex_review CI, scripts/codex-review-ci.sh, runner installation, or automated MR review behavior.
---
