---
name: ai-do-agent-work-intake
description: Convert AI-DO plans, bugs, and feature requests into GitLab Issues with consistent PRD, triage, and ready-for-agent briefs. Use when creating or refining work for multiple maintainers or AFK agents.
---
