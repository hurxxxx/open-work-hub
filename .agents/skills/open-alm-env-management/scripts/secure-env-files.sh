...
REPO_NAME="${OPEN_ALM_GITLAB_REPO:-open-alm/open-alm}"
PROJECT_PATH="${OPEN_ALM_GITLAB_PROJECT_PATH:-open-alm%2Fopen-alm}"
...
Profiles:
  production -> .env.production, default source /projects/open-alm/prod/.env
...
default_source_for_profile() {
  case "$1" in
    production) echo "/projects/open-alm/prod/.env" ;;
