---
name: owh-worktrees
description: Use when branch/worktree operations are requested or a dirty/wrong checkout needs isolation. Excludes routine edits in clean dev; isolation does not authorize commits or publication.
---
