  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed right-0 top-0 z-[var(--ui-z-drawer)] flex h-screen w-[min(420px,100vw)] flex-col gap-3 border-l border-l-[var(--ui-color-border)] bg-ui-surface-raised p-4 shadow-[var(--ui-shadow-lg)] outline-none">
