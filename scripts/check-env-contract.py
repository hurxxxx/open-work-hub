...
SETTINGS_FILE_PARTS = [
    Path("apps/api/src/open_alm_api/core/settings.py"),
    Path("apps/worker/src/open_alm_worker/settings.py"),
]
SETTINGS_FILES = [ROOT / part for part in SETTINGS_FILE_PARTS]
DEPLOY_ENV_KEYS = frozenset(
    {
        "OPEN_ALM_PROD_BACKUP_ROOT",
        "OPEN_ALM_PROD_BRANCH",
        "OPEN_ALM_PROD_KEYWORD_REINDEX_ALL_ACTIVE",
        "OPEN_ALM_PROD_KEYWORD_REINDEX_WORKSPACE_KEYS",
        "OPEN_ALM_PROD_MODEL_SETTINGS_CUTOVER_ENV_FILE",
        "OPEN_ALM_PROD_RELEASE_GATE_ADAPTERS",
        "OPEN_ALM_PROD_REMOTE_REF",
        "OPEN_ALM_PROD_ROOT",
        "OPEN_ALM_PROD_SMOKE_ATTEMPTS",
        "OPEN_ALM_PROD_SMOKE_CELERY_TIMEOUT_SECONDS",
        "OPEN_ALM_PROD_SMOKE_DELAY_SECONDS",
        "OPEN_ALM_PROD_SMOKE_WEB_HOST",
        "OPEN_ALM_PROD_SMOKE_WORKSPACE_PATH",
        "OPEN_ALM_PROD_SKIP_RELEASE_GATES",
    }
)

FORBIDDEN_ENV_KEYS = frozenset(
    {
        "OPEN_ALM_AI_MANAGER_ENABLED",
        "OPEN_ALM_AI_MANAGER_HOSTED_TOOLS_ENABLED",
        "OPEN_ALM_AI_MANAGER_MAX_LOOPS",
        "OPEN_ALM_AI_MANAGER_MODEL",
        "OPEN_ALM_AI_MANAGER_PROVIDER",
        "OPEN_ALM_AI_MANAGER_STORE_RESPONSE",
        "OPEN_ALM_AI_MANAGER_TRACE_SENSITIVE_DATA",
        "OPEN_ALM_API_RECORDING_CHUNK_SECONDS",
        "OPEN_ALM_CUSTOMER_CODE",
        "OPEN_ALM_ENABLED_EXTENSION_APPS",
        "OPEN_ALM_HR_GROUPWARE_DB_SOURCE_DATABASE",
        "OPEN_ALM_INFERENCE_GATEWAY_ASR_CONCURRENCY",
        "OPEN_ALM_INFERENCE_GATEWAY_ASR_ENABLED",
        "OPEN_ALM_INFERENCE_GATEWAY_ASR_LANGUAGE",
        "OPEN_ALM_INFERENCE_GATEWAY_ASR_MAX_NEW_TOKENS",
        "OPEN_ALM_INFERENCE_GATEWAY_ASR_MODEL",
        "OPEN_ALM_INFERENCE_GATEWAY_ASR_PUBLIC_MODEL",
        "OPEN_ALM_INFERENCE_GATEWAY_ASR_REVISION",
        "OPEN_ALM_INFERENCE_GATEWAY_DEVICE",
        "OPEN_ALM_INFERENCE_GATEWAY_DOCLING_CONCURRENCY",
        "OPEN_ALM_INFERENCE_GATEWAY_DOCLING_ENABLED",
        "OPEN_ALM_INFERENCE_GATEWAY_DTYPE",
        "OPEN_ALM_INFERENCE_GATEWAY_EMBEDDING_BATCH_SIZE",
        "OPEN_ALM_INFERENCE_GATEWAY_EMBEDDING_CONCURRENCY",
        "OPEN_ALM_INFERENCE_GATEWAY_EMBEDDING_ENABLED",
        "OPEN_ALM_INFERENCE_GATEWAY_EMBEDDING_MODEL",
        "OPEN_ALM_INFERENCE_GATEWAY_EMBEDDING_QUERY_PROMPT_NAME",
        "OPEN_ALM_INFERENCE_GATEWAY_EMBEDDING_REVISION",
        "OPEN_ALM_INFERENCE_GATEWAY_HF_TOKEN_FILE",
        "OPEN_ALM_INFERENCE_GATEWAY_HOST",
        "OPEN_ALM_INFERENCE_GATEWAY_MAX_EMBEDDING_INPUTS",
        "OPEN_ALM_INFERENCE_GATEWAY_MAX_RERANK_DOCUMENTS",
        "OPEN_ALM_INFERENCE_GATEWAY_MAX_TEXT_CHARS",
        "OPEN_ALM_INFERENCE_GATEWAY_MAX_UPLOAD_BYTES",
        "OPEN_ALM_INFERENCE_GATEWAY_PORT",
        "OPEN_ALM_INFERENCE_GATEWAY_RERANKER_BATCH_SIZE",
        "OPEN_ALM_INFERENCE_GATEWAY_RERANKER_CONCURRENCY",
        "OPEN_ALM_INFERENCE_GATEWAY_RERANKER_ENABLED",
        "OPEN_ALM_INFERENCE_GATEWAY_RERANKER_MODEL",
        "OPEN_ALM_INFERENCE_GATEWAY_RERANKER_REVISION",
        "OPEN_ALM_LEGACY_ISSUES_ALLOWED_ROOT",
        "OPEN_ALM_LEGACY_ISSUES_SOURCE_ROOT",
        "OPEN_ALM_NEWS_CRAWL_HOUR",
        "OPEN_ALM_NEWS_CRAWL_HOUR_2",
        "OPEN_ALM_PATENT_BIGQUERY_ENABLED",
        "OPEN_ALM_PATENT_BIGQUERY_JOB_MAX_ESTIMATED_BYTES",
        "OPEN_ALM_PATENT_BIGQUERY_LIMIT_PER_QUERY",
        "OPEN_ALM_PATENT_BIGQUERY_MAX_BYTES_BILLED",
        "OPEN_ALM_PATENT_BIGQUERY_MAX_QUERIES_PER_JOB",
        "OPEN_ALM_PATENT_BIGQUERY_SEARCH_ABSTRACT",
        "OPEN_ALM_PATENT_BIGQUERY_TABLE",
        "OPEN_ALM_PATENT_BIGQUERY_TIMEOUT_SECONDS",
        "OPEN_ALM_PATENT_ENABLE_GOOGLE_XHR",
        "OPEN_ALM_PATENT_EPO_OPS_CONSUMER_KEY",
        "OPEN_ALM_PATENT_EPO_OPS_CONSUMER_SECRET",
        "OPEN_ALM_PATENT_JPO_API_BASE_URL",
        "OPEN_ALM_PATENT_JPO_API_TOKEN",
        "OPEN_ALM_PATENT_USPTO_ODP_API_KEY",
        "OPEN_ALM_PROD_FRONTEND_ASSET_RETENTION_DAYS",
        "OPEN_ALM_RAG_UI_ENABLED",
...
FORBIDDEN_ENV_PATTERNS = [
    re.compile(r"\bOPEN ALM_[A-Z0-9_]*\b"),
    re.compile(r"\bPLM_ORACLE_[A-Z0-9_]*\b"),
    re.compile(r"(?<!OPEN_ALM_)\bLOCAL_AI_[A-Z0-9_]*\b"),
    ...
    re.compile(r"\bOPEN_ALM_REDIS_URL\b"),
]
...
SKIP_SETTINGS_KEYS = {"OPEN_ALM_API_OPEN_ALM_DESKTOP_UPDATE_DIRS"}
...
SOURCE_FILE_NAMES = {".env", ".env.example", ".gitlab-ci.yml"}
