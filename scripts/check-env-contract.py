...
SETTINGS_FILE_PARTS = [
    Path("apps/api/src/ai_do_api/core/settings.py"),
    Path("apps/worker/src/ai_do_worker/settings.py"),
]
SETTINGS_FILES = [ROOT / part for part in SETTINGS_FILE_PARTS]
DEPLOY_ENV_KEYS = frozenset(
    {
        "AI_DO_PROD_BACKUP_ROOT",
        "AI_DO_PROD_BRANCH",
        "AI_DO_PROD_KEYWORD_REINDEX_ALL_ACTIVE",
        "AI_DO_PROD_KEYWORD_REINDEX_WORKSPACE_KEYS",
        "AI_DO_PROD_MODEL_SETTINGS_CUTOVER_ENV_FILE",
        "AI_DO_PROD_RELEASE_GATE_ADAPTERS",
        "AI_DO_PROD_REMOTE_REF",
        "AI_DO_PROD_ROOT",
        "AI_DO_PROD_SMOKE_ATTEMPTS",
        "AI_DO_PROD_SMOKE_CELERY_TIMEOUT_SECONDS",
        "AI_DO_PROD_SMOKE_DELAY_SECONDS",
        "AI_DO_PROD_SMOKE_WEB_HOST",
        "AI_DO_PROD_SMOKE_WORKSPACE_PATH",
        "AI_DO_PROD_SKIP_RELEASE_GATES",
    }
)
...
FORBIDDEN_ENV_KEYS = frozenset(
    {
        ...
        "AI_DO_API_RECORDING_CHUNK_SECONDS",
        "AI_DO_CUSTOMER_CODE",
        "AI_DO_ENABLED_EXTENSION_APPS",
        "AI_DO_HR_GROUPWARE_DB_SOURCE_DATABASE",
        "AI_DO_INFERENCE_GATEWAY_ASR_CONCURRENCY",
        "AI_DO_INFERENCE_GATEWAY_ASR_ENABLED",
        "AI_DO_INFERENCE_GATEWAY_ASR_LANGUAGE",
        "AI_DO_INFERENCE_GATEWAY_ASR_MAX_NEW_TOKENS",
        "AI_DO_INFERENCE_GATEWAY_ASR_MODEL",
        "AI_DO_INFERENCE_GATEWAY_ASR_PUBLIC_MODEL",
        "AI_DO_INFERENCE_GATEWAY_ASR_REVISION",
        "AI_DO_INFERENCE_GATEWAY_DEVICE",
        "AI_DO_INFERENCE_GATEWAY_DOCLING_CONCURRENCY",
        "AI_DO_INFERENCE_GATEWAY_DOCLING_ENABLED",
        "AI_DO_INFERENCE_GATEWAY_DTYPE",
        "AI_DO_INFERENCE_GATEWAY_EMBEDDING_BATCH_SIZE",
        "AI_DO_INFERENCE_GATEWAY_EMBEDDING_CONCURRENCY",
        "AI_DO_INFERENCE_GATEWAY_EMBEDDING_ENABLED",
        "AI_DO_INFERENCE_GATEWAY_EMBEDDING_MODEL",
        "AI_DO_INFERENCE_GATEWAY_EMBEDDING_QUERY_PROMPT_NAME",
        "AI_DO_INFERENCE_GATEWAY_EMBEDDING_REVISION",
        "AI_DO_INFERENCE_GATEWAY_HF_TOKEN_FILE",
        "AI_DO_INFERENCE_GATEWAY_HOST",
        "AI_DO_INFERENCE_GATEWAY_MAX_EMBEDDING_INPUTS",
        "AI_DO_INFERENCE_GATEWAY_MAX_RERANK_DOCUMENTS",
        "AI_DO_INFERENCE_GATEWAY_MAX_TEXT_CHARS",
        "AI_DO_INFERENCE_GATEWAY_MAX_UPLOAD_BYTES",
        "AI_DO_INFERENCE_GATEWAY_PORT",
        "AI_DO_INFERENCE_GATEWAY_RERANKER_BATCH_SIZE",
        "AI_DO_INFERENCE_GATEWAY_RERANKER_CONCURRENCY",
        "AI_DO_INFERENCE_GATEWAY_RERANKER_ENABLED",
        "AI_DO_INFERENCE_GATEWAY_RERANKER_MODEL",
        "AI_DO_INFERENCE_GATEWAY_RERANKER_REVISION",
        "AI_DO_LEGACY_ISSUES_ALLOWED_ROOT",
        "AI_DO_LEGACY_ISSUES_SOURCE_ROOT",
        "AI_DO_NEWS_CRAWL_HOUR",
        "AI_DO_NEWS_CRAWL_HOUR_2",
        "AI_DO_PATENT_BIGQUERY_ENABLED",
        "AI_DO_PATENT_BIGQUERY_JOB_MAX_ESTIMATED_BYTES",
        "AI_DO_PATENT_BIGQUERY_LIMIT_PER_QUERY",
        "AI_DO_PATENT_BIGQUERY_MAX_BYTES_BILLED",
        "AI_DO_PATENT_BIGQUERY_MAX_QUERIES_PER_JOB",
        "AI_DO_PATENT_BIGQUERY_SEARCH_ABSTRACT",
        "AI_DO_PATENT_BIGQUERY_TABLE",
        "AI_DO_PATENT_BIGQUERY_TIMEOUT_SECONDS",
        "AI_DO_PATENT_ENABLE_GOOGLE_XHR",
        "AI_DO_PATENT_EPO_OPS_CONSUMER_KEY",
        "AI_DO_PATENT_EPO_OPS_CONSUMER_SECRET",
        "AI_DO_PATENT_JPO_API_BASE_URL",
        "AI_DO_PATENT_JPO_API_TOKEN",
        "AI_DO_PATENT_USPTO_ODP_API_KEY",
        "AI_DO_PROD_FRONTEND_ASSET_RETENTION_DAYS",
...
FORBIDDEN_ENV_PATTERNS = [
    re.compile(r"\bDOOWON_[A-Z0-9_]*\b"),
    re.compile(r"\bPLM_ORACLE_[A-Z0-9_]*\b"),
    re.compile(r"(?<!AI_DO_)\bLOCAL_AI_[A-Z0-9_]*\b"),
    ...
    re.compile(r"\bAI_DO_REDIS_URL\b"),
]
...
SKIP_SETTINGS_KEYS = {"AI_DO_API_AI_DO_DESKTOP_UPDATE_DIRS"}
