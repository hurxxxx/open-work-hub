...
RETIRED_TRIAGE_PATTERNS = {
    r"\benhancement\b": "feature issues do not use a category label",
    r"\bneeds-info\b": "needs-info is not a live GitLab label",
    r"\bready-for-human\b": "ready-for-human is not a live GitLab label",
    r"\bwontfix\b": "wontfix is not a live GitLab label",
