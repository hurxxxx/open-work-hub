...
uv run ruff check \
  src/ai_do_api/domains/admin/router.py \
  src/ai_do_api/domains/ai/router.py \
  src/ai_do_api/domains/ai/runtime/external_egress.py \
  src/ai_do_api/domains/ai/runtime/external_adapters.py \
  src/ai_do_api/domains/ai/runtime/metrics.py \
