...
export OPEN_WORK_HUB_DEV_API_HOST="${OPEN_WORK_HUB_DEV_API_HOST:-127.0.0.1}"
export OPEN_WORK_HUB_WEB_DEV_HOST="${OPEN_WORK_HUB_WEB_DEV_HOST:-127.0.0.1}"
export OPEN_WORK_HUB_INFRA_CONTAINER_PREFIX="${OPEN_WORK_HUB_INFRA_CONTAINER_PREFIX:-open-work-hub-dev}"
export OPEN_WORK_HUB_INFRA_BIND_HOST="${OPEN_WORK_HUB_INFRA_BIND_HOST:-127.0.0.1}"
...
export OPEN_WORK_HUB_INFRA_POSTGRES_DB="${OPEN_WORK_HUB_INFRA_POSTGRES_DB:-open_work_hub_dev}"
export OPEN_WORK_HUB_INFRA_POSTGRES_PASSWORD="${OPEN_WORK_HUB_INFRA_POSTGRES_PASSWORD:-open_work_hub_dev}"
export OPEN_WORK_HUB_INFRA_POSTGRES_PORT="${OPEN_WORK_HUB_INFRA_POSTGRES_PORT:-55433}"
export OPEN_WORK_HUB_INFRA_POSTGRES_USER="${OPEN_WORK_HUB_INFRA_POSTGRES_USER:-open_work_hub_dev}"
export OPEN_WORK_HUB_INFRA_USE_LOCAL_POSTGRES="${OPEN_WORK_HUB_INFRA_USE_LOCAL_POSTGRES:-auto}"
...
export OPEN_WORK_HUB_BENTO_BIND_HOST="${OPEN_WORK_HUB_BENTO_BIND_HOST:-127.0.0.1}"
export OPEN_WORK_HUB_BENTO_IMAGE_TAG="${OPEN_WORK_HUB_BENTO_IMAGE_TAG:-1.0.17}"
export OPEN_WORK_HUB_BENTO_PORT="${OPEN_WORK_HUB_BENTO_PORT:-18084}"
export OPEN_WORK_HUB_BENTO_SERVER_URL="${OPEN_WORK_HUB_BENTO_SERVER_URL:-http://127.0.0.1:${OPEN_WORK_HUB_BENTO_PORT}/}"
if [[ -z "${OPEN_WORK_HUB_HERMES_ENABLED+x}" ]]; then
  if [[ -n "${OPENROUTER_API_KEY:-}" ]]; then
    export OPEN_WORK_HUB_HERMES_ENABLED=true
  else
    export OPEN_WORK_HUB_HERMES_ENABLED=false
  fi
fi
export OPEN_WORK_HUB_HERMES_RUNTIME_PORT="${OPEN_WORK_HUB_HERMES_RUNTIME_PORT:-18642}"
export OPEN_WORK_HUB_HERMES_MANAGEMENT_PORT="${OPEN_WORK_HUB_HERMES_MANAGEMENT_PORT:-19119}"
export OPEN_WORK_HUB_HERMES_RUNTIME_BASE_URL="${OPEN_WORK_HUB_HERMES_RUNTIME_BASE_URL:-http://127.0.0.1:${OPEN_WORK_HUB_HERMES_RUNTIME_PORT}}"
export OPEN_WORK_HUB_HERMES_MANAGEMENT_BASE_URL="${OPEN_WORK_HUB_HERMES_MANAGEMENT_BASE_URL:-http://127.0.0.1:${OPEN_WORK_HUB_HERMES_MANAGEMENT_PORT}}"
export OPEN_WORK_HUB_HERMES_API_KEY="${OPEN_WORK_HUB_HERMES_API_KEY:-open-work-hub-dev-hermes-runtime-key-0001}"
export OPEN_WORK_HUB_HERMES_MANAGEMENT_TOKEN="${OPEN_WORK_HUB_HERMES_MANAGEMENT_TOKEN:-open-work-hub-dev-hermes-management-token-0001}"
export OPEN_WORK_HUB_HERMES_MCP_SHARED_SECRET="${OPEN_WORK_HUB_HERMES_MCP_SHARED_SECRET:-open-work-hub-dev-hermes-mcp-shared-secret-0000000000000001}"
export OPEN_WORK_HUB_HERMES_MCP_SERVER_URL="${OPEN_WORK_HUB_HERMES_MCP_SERVER_URL:-http://127.0.0.1:${OPEN_WORK_HUB_API_DEV_PORT:-8001}/api/v1/internal/hermes/mcp}"
export OPEN_WORK_HUB_HERMES_PROFILE_CLONE_SOURCE="${OPEN_WORK_HUB_HERMES_PROFILE_CLONE_SOURCE:-default}"
export OPEN_WORK_HUB_HERMES_REQUEST_TIMEOUT_SECONDS="${OPEN_WORK_HUB_HERMES_REQUEST_TIMEOUT_SECONDS:-30}"
export OPEN_WORK_HUB_HERMES_RUN_TIMEOUT_SECONDS="${OPEN_WORK_HUB_HERMES_RUN_TIMEOUT_SECONDS:-3600}"
export OPEN_WORK_HUB_HERMES_DISPATCH_LEASE_SECONDS="${OPEN_WORK_HUB_HERMES_DISPATCH_LEASE_SECONDS:-300}"
...
export OPEN_WORK_HUB_POSTGRES_DSN="${OPEN_WORK_HUB_POSTGRES_DSN:-postgresql+psycopg://${OPEN_WORK_HUB_INFRA_POSTGRES_USER}:${OPEN_WORK_HUB_INFRA_POSTGRES_PASSWORD}@127.0.0.1:${OPEN_WORK_HUB_INFRA_POSTGRES_PORT}/${OPEN_WORK_HUB_INFRA_POSTGRES_DB}}"
...
export OPEN_WORK_HUB_API_OBJECT_STORAGE_REQUIRED="${OPEN_WORK_HUB_API_OBJECT_STORAGE_REQUIRED:-1}"
export OPEN_WORK_HUB_API_SEED_DEV_LOGIN_ACCOUNT="${OPEN_WORK_HUB_API_SEED_DEV_LOGIN_ACCOUNT:-1}"
dev_export_open_work_hub_desktop_installer_defaults
...
dev_use_local_postgres() {
  case "$(dev_lower "$OPEN_WORK_HUB_INFRA_USE_LOCAL_POSTGRES")" in
    1|true|yes|on)
      return 0
      ;;
    0|false|no|off)
      ...
      ;;
    auto)
      if [[ "$OPEN_WORK_HUB_POSTGRES_DSN" == *"127.0.0.1:${OPEN_WORK_HUB_INFRA_POSTGRES_PORT}"* ]] || \
         [[ "$OPEN_WORK_HUB_POSTGRES_DSN" == *"localhost:${OPEN_WORK_HUB_INFRA_POSTGRES_PORT}"* ]]; then
        return 0
      fi
      return 1
      ;;
    *)
      echo "[dev] invalid OPEN_WORK_HUB_INFRA_USE_LOCAL_POSTGRES: $OPEN_WORK_HUB_INFRA_USE_LOCAL_POSTGRES" >&2
      return 1
      ;;
  esac
}
