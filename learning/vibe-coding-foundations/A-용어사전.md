...
> Open Work Hub 교육 자료에서 자주 등장하는 IT·개발 용어를 **비개발자 기준**으로 짧게 풀어 둔 사전입니다. 각 항목은 문장 1~3개의 정의 + 이 프로젝트에서의 위치로 구성됩니다. 가나다 순.
...
**버킷(Bucket)**
객체 저장소의 최상위 폴더(실은 평면 컨테이너). MinIO의 `open-work-hub-uploads` 등(31장).
