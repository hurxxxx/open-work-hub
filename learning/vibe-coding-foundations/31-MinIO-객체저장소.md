...
- **버킷**: 최상위 컨테이너. `ai-do-uploads`, `ai-do-avatars` 등.
...
client.put_object("ai-do-uploads", "documents/abc.pdf", file_stream, length)
url = client.presigned_get_object("ai-do-uploads", "documents/abc.pdf", expires=600)
```
