...
Open ALM는 검색만 하는 포털에서 문서 초안, 메일 초안, PLM 조회, 이슈 등록, 문서 생성으로 확장될 수 있다. 이때 모든 기능을 LLM에게 열어 주면 안 된다. capability 계약, read/write 구분, 승인 게이트, 감사 로그가 필요하다.
