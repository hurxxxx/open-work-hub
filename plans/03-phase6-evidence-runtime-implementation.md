...
- Current PR/stage: Phase 0-AI external adapter selection helpers after `1b3a917`.
- Last completed: Added settings-driven external planner/search adapter selection helpers. New settings `AIDOO_AI_EXTERNAL_PLANNER_EXECUTION_ADAPTER` and `AIDOO_AI_EXTERNAL_SEARCH_EXECUTION_ADAPTER` default to `mock`. Unknown adapter names do not trigger provider calls; they return trace-safe failed results with `error_class=adapter_not_implemented`, raw output unpersisted, and search digest/cache metadata when a query is available. Router external execution now uses the selector helpers.
- In progress: None.
- Next exact task: Add route-level coverage for unimplemented external adapter selection so stream metadata shows provider failure safely while graph execution continues with local/mock runtime behavior.
- Files touched in Phase 0-AI: `apps/api/src/aidoo_api/core/settings.py`, `apps/api/src/aidoo_api/domains/ai/router.py`, `apps/api/src/aidoo_api/domains/ai/runtime/__init__.py`, `apps/api/src/aidoo_api/domains/ai/runtime/external_adapters.py`, `apps/api/src/aidoo_api/domains/ai/runtime/external_planner.py`, `apps/api/src/aidoo_api/domains/ai/runtime/external_search.py`, `apps/api/tests/test_ai_runtime_external_adapters.py`, `apps/api/tests/test_ai_runtime_external_planner.py`, `apps/api/tests/test_ai_runtime_external_search.py`, `apps/api/tests/test_ai_runtime_settings.py`, `plans/03-phase6-evidence-runtime-implementation.md`.
- Tests/checks run: `cd apps/api && uv run ruff check src/aidoo_api/core/settings.py src/aidoo_api/domains/ai/router.py src/aidoo_api/domains/ai/runtime/__init__.py src/aidoo_api/domains/ai/runtime/external_adapters.py src/aidoo_api/domains/ai/runtime/external_planner.py src/aidoo_api/domains/ai/runtime/external_search.py tests/test_ai_runtime_external_adapters.py tests/test_ai_runtime_external_planner.py tests/test_ai_runtime_external_search.py tests/test_ai_runtime_settings.py`; `cd apps/api && uv run pytest tests/test_ai_runtime_external_adapters.py tests/test_ai_runtime_external_planner.py tests/test_ai_runtime_external_search.py tests/test_ai_runtime_settings.py tests/test_ai_runtime_eval_fixtures.py tests/test_ai_runtime_mock_e2e.py`; `scripts/phase6-mock-e2e.sh -q`.
