...
| 파일 | 유형 | 상태 |
|---|---|---|
| [`00-ai-platform-roadmap.md`](./00-ai-platform-roadmap.md) | 로드맵 | 승인 완료, Phase 4 진행 중 |
| [`04-phase4-write-meeting.md`](./04-phase4-write-meeting.md) | Phase 4 실행 | 작성 완료, 리뷰/승인 대기 |
