...
| 파일 | 유형 | 상태 |
|---|---|---|
| [`00-ai-platform-roadmap.md`](./00-ai-platform-roadmap.md) | 로드맵 | 승인 완료, Phase 5 계획 반영 |
| [`05-phase5-rag-integration.md`](./05-phase5-rag-integration.md) | Phase 5 실행 | 작성 완료, 리뷰/승인 대기 |
